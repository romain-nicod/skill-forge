const STRINGS = {
  fr: {
    ...
    'footer.note': 'Skill Forge — 100 % statique : vos réponses ne quittent jamais votre navigateur.',
  ...
  en: {
    ...
    'footer.note': 'Skill Forge — 100% static: your answers never leave your browser.',
